...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_path", type=str, required=True, help="Path to the input image or PDF file.")
    ...
    if input_path.lower().endswith('.pdf'):
        ...
        for img, page_num in tqdm(images, total=len(images), desc="Processing PDF pages"):
            ...
            extracted_text = "\n\n".join([item['text'] for item in ocr_data if 'text' in item])
